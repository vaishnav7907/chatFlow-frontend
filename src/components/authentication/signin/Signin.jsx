...
const navigation= useNavigate()
  ...
  const submitt = async (e) => {
    ...
    try {
     const signinapi= await axios.post(`${import.meta.env.VITE_API_URL}/ChatFlow/signin`, {
        Email,
        Password,
      });
          ...
          <div className="pt-7">
            <form action="" onSubmit={submitt}>
              <div className="flex flex-col gap-3 ">
                ...
                <div className="pt-7">
                  <button className=" bg-gradient-to-r from-[#7C4DFF] via-[#6938EF] to-[#5B21B6] hover:from-[#8B5CF6] hover:via-[#7C3AED] hover:to-[#6D28D9] w-full h-12  rounded-2xl text-white" type="submit">
                    Stay Connected
                  </button>
                </div>
              </div>
