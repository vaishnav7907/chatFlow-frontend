  ...
  return (
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a] relative overflow-hidden flex justify-center items-center">
      <div className=" flex flex-col justify-center items-center gap-5">
        ...
        <div
          className="bg-white h-8 w-8 rounded-full flex justify-center items-center mt-7 animate-pulse"
          onClick={() => navigate("/authentication")}
        >
          <div className="h-6 w-6 rounded-full bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0f172a]"></div>
        </div>
      </div>
    </div>
  );
